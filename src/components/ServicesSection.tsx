...
const ServicesSection = () => {
  const services = [
    ...
    },
    {
      ...
      description: 'تعرف على الشروط والخطوات اللازمة للحصول على رخصة القيادة',
      features: ['أنواع الرخص', 'المتطلبات', 'ساعات التدريب', 'المدة التقريبية'],
      color: 'bg-success',
    ...
    },
    {
      ...
      description: 'دليل شامل لإجراءات الحصول على رخصة القيادة والترخيص الرسمي',
      features: ['الأوراق المطلوبة', 'الرسوم والأسعار', 'إجراءات الفحص', 'خطوات التقديم'],
      color: 'bg-warning',
      href: '/license-guide'
    },
    {
